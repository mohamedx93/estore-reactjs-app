...
export default function Logo({ className = '', width, height, ...props }: logoProps): ReactElement {
    return (
        // <VectorContainer className={className} {...props} xmlns="http://www.w3.org/2000/svg">
        //     <path
        ...
        // </VectorContainer>
        <Image src='/logo2.png' className={className} width={width} height={height} {...props} />
    );
}

const VectorContainer = styled.svg`
    width: 34px;
    height: 30px;
    scale: 1;
`